...
///
/// This interface sets the orientation of the video. The captued image is rotated according to the value of the parameter [UIInterfaceOrientation] compared to the forward direction of the phone. After rotation, it will be automatically adjusted to adapt the encoded image resolution.
/// @param orientation Video orientation
/// @param channel Publish stream channel
