...
///
/// Turning on echo cancellation, the SDK filters the collected audio data to reduce the echo component in the audio. It needs to be set before starting the push, and the setting is invalid after the start of the push.
...
///
/// Switch different echo cancellation modes to control the extent to which echo data is eliminated. Need to be set before starting the push.
/// @param mode Echo cancellation mode
- (void)setAECMode:(ZegoAECMode)mode;

/// On/off automatic gain control
///
/// When the auto gain is turned on, the sound will be amplified, but it will affect the sound quality to some extent. Need to be set before starting the push.
/// @param enable Whether to enable automatic gain control, YES: enable AGC, NO: disable AGC
- (void)enableAGC:(BOOL)enable;

/// On/off noise suppression
///
/// Turning on the noise suppression switch can reduce the noise in the audio data and make the human voice clearer. Need to be set before starting the push.
/// @param enable Whether to enable noise suppression, YES: enable AGC, NO: disable AGC
- (void)enableANS:(BOOL)enable;

/// On/off beauty
///
/// Identify the portraits in the video for beauty. It can be set before and after the start of the push.
